"""add relationships and audit fields to all models

Revision ID: 8ec3984be622
Revises: b8e5e43b379d
Create Date: 2026-01-08 01:27:29.322139
...
revision: str = '8ec3984be622'
down_revision: Union[str, None] = 'b8e5e43b379d'
...
def upgrade() -> None:
    ...
    op.add_column('ticket_types', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('ticket_types', 'deleted_at')
